...
function Model() {
  const gltf = useLoader(GLTFLoader, '/buildings/jmc.glb');
...
export default function FloorPage() {
  ...
  const buildings = [
    { name: "JMC 1ST FLOOR", path: "/jmc-first-floor" },
    { name: "JMC 2ND FLOOR", path: "/jmc-second-floor" },
    { name: "JMC 3RD FLOOR", path: "/jmc-third-floor" }
  ];

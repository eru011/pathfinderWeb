...
import svgPath from "../assets/3JMC.svg";
import jmc1_3DModel from "../assets/3d-models/jmc-3.glb";
import "../App.css";
...
function App() {
  ...
  const handleFloorNavigation = () => {
    navigate('/jmc-second-floor');  // Only going down from 3rd floor
  };

  // Modify your useEffect that watches for room changes
  useEffect(() => {
    setShowPath(false);
